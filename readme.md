...
作为ECLA第一批住户，从18年12月开始入住，这套方案19年1月就部署上开始用了。除了ECLA多次升级网络更改了网络SSID需要重新桥接之外，一直没出过问题。对的，从一开始ECLA的网络就不是特别稳定，但有神器护体对我没啥影响。某云vip下载基本能跑到`4mb/s`。之前一直没时间写教程，最近咬牙整了这篇教程，权当抛个砖。欢迎交流。
